package com.fitness_application.auth.controller;
...
import com.fitness_application.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> validateToken(@RequestBody Map<String, String> tokenRequest) {
